...
/* This code generates a warning about exceeding array bounds */
                ...
                */
                ...
                loop1:
                    ...
                    {          /* is pin a OLMC pin? */
                        if (((gal_type == GAL16V8) && (actPin.p_Pin >= 12) &&
                             (actPin.p_Pin <= 19)) ||
                            ((gal_type == GAL20V8) && (actPin.p_Pin >= 15) &&
                             (actPin.p_Pin <= 22)) ||
                            ((gal_type == GAL22V10) && (actPin.p_Pin >= 14) &&
                             (actPin.p_Pin <= DUMMY_OLMC12)) ||
                            ((gal_type == GAL20RA10) && (actPin.p_Pin >= 14) &&
                             (actPin.p_Pin <= 23))) {
...
void IsPinName(UBYTE* pinnames, int numofpins) {
    ...
    if (n) {
        if ((n == 2) && !strncmp((char*)oldactptr, "NC", (size_t)2))
            ...
            for (k = 0; k < numofpins; k++) { /* examine whole list of pin names */
                i = 0;
                ...
                if (n == strlen((char*)(pinnames + k * 10 + i)))
                    if (!(strncmp((char*)oldactptr,
                                  (char*)(pinnames + k * 10 + i),
